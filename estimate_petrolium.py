"""
This script takes the CWON estimates for natural capital rents as national GEP values for petrol. 
"""
...
df_gep = pd.read_excel("../data/cwon-resource-rents/cwon-rents-oil.xlsx")
# Keep only 2019 
col_keep = ['countrycode', 'countryname', 'YR2019']
df_gep = df_gep[col_keep]
# Rename 2019 to gep_oil 
df_gep.rename(columns= {'YR2019': 'gep_oil', 'countrycode': 'country_code', 'countryname': 'country'}, inplace=True)
...
df_merged = df_merged[['ee_r264_id', 'iso3_r250_id', 'iso3_r250_label', 'ee_r264_description', 'gep_oil']]
